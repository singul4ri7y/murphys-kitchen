...
export const DialogWrapper = ({ children }: { children: React.ReactNode }) => {
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-xl border border-border bg-card/95 backdrop-blur-sm",
        desktopClassName,
        tabletClassName,
        mobileClassName,
      )}
...
export const StaticTextBlockWrapper = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <p
        className={cn(
          "max-w-[650px] text-center text-base sm:text-lg text-muted-foreground",
          descriptionClassName,
        )}
      >
        {description}

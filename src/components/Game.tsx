  ...
  return (
    <motion.h3
      className={cn(
        ...
        variant === "naughty" ? "text-destructive" : "text-success",
      )}
...
export const Game: React.FC = memo(() => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 flex items-center justify-center border-t border-border bg-card/80 backdrop-blur-sm p-4 pt-3">
      <div className="flex w-full max-w-[628px] items-center justify-center gap-3 sm:gap-4">
        ...
        <div className="flex w-full items-center justify-between gap-1">
          <div className="grid w-full grid-cols-4 items-center justify-between gap-1">
            <div
              className={cn(
                "h-2 w-full rounded-full bg-muted transition-all duration-300",
                {
